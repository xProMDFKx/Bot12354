...
client.on("message", async message => {
  ...
  if(command === "kick") {
    ...
    if(!message.member.roles.some(r=>["« ℑ | Fondatori »", "Moderator", "Unicul Fondator", "Founder || 孩", "⚒️ Cheif - Detinator"].includes(r.name)) )
  ...
  if(command === "ban") {
    ...
    if(!message.member.roles.some(r=>["« ℑ | Fondatori »", "Unicul Fondator", "Founder || 孩", "⚒️ Cheif - Detinator"].includes(r.name)) )
      return message.reply(":exclamation: Sorry, nu ai acces la aceasta comanda!");
